...
function createSearchOverlay() {
	...
	// searchoverlay.innerHTML = '<div class="searchBar">' +
	// 	'Search Haus Alpenz (just try a few letters): ' +
	// 	'<input id="searchBox" type="text" hx-get="https://localhost:6543/hsearch/" hx-target="#searchResults" hx-trigger="keyup delay:500ms"></div>' + 
	// 	'<span id="dismissSearchOverlay">' + 
	// 	'<img src="gfx/dismiss.png" height="18" width="18" /></span>' + 
	// 	'<div id="searchResults"></div>';
	// main.appendChild(shadowbox);
	// main.appendChild(searchoverlay);

	// htmx.process(document.getElementById('searchBox'));
